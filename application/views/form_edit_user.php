				...
				<div class="panel-body">
				  ...
				  <input value="<?php echo $query['id_role'] ;?>" id="id_role" name="id_role" type="hidden" >
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-10">
						<input class="form-control" data-required="true" placeholder="Password" type="password" name="password1" id="password1" minlength="6">
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-lg-2 control-label">New Password</label>
					  <div class="col-lg-10">
						<input class="form-control" data-required="true" placeholder="Masukkan lagi password"  type="password" name="password" id="password" onkeyup="checkPass(); return false;" minlength="6">
					  </div>
					</div>
